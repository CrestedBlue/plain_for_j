...
export function DayTabs({ days, activeIndex, onSelect }: Props) {
  return (
    <div className="bg-white dark:bg-slate-800/80 p-1 rounded-xl border border-slate-200 dark:border-slate-700/50 shadow-md flex gap-1 overflow-x-auto scrollbar-none">
      {days.map((day, index) => {
